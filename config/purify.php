...
return [
    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title],ul,ol,li[data-list|class],p[style|class],br,span[class|style],img[width|height|alt|src],blockquote[class]',
    ...
    */
    ...
    'definitions' => \App\Purify\CustomDefinition::class,
