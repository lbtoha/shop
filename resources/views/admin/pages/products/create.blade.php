        ...
        <form action="{{ route('admin.products.store') }}" class="form-submit-edit" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-6">
                <div class="md:col-span-2">
                    <x-admin::text-input-group name="name" label="{{ __('Name') }}" placeholder="{{ __('Enter Product Name') }}" :required="true" />
                </div>
                ...
                <div>
                    <x-admin::text-input-group name="sku" label="{{ __('SKU') }}" placeholder="{{ __('Enter SKU') }}" />
                </div>

                <div>
                    <x-admin::number-input-group name="price" label="{{ __('Price') }}" placeholder="0.00" />
                </div>

                <div>
                    <x-admin::number-input-group name="compare_at_price" label="{{ __('Compare At Price') }}" placeholder="0.00" />
                </div>

                <div>
                    <x-admin::number-input-group name="stock" label="{{ __('Stock') }}" placeholder="0" :with_currencySymbol="false" />
                </div>

                <div class="md:col-span-2">
                    <x-admin::textarea-group name="short_description" label="{{ __('Short Description') }}" placeholder="{{ __('Enter Short Description') }}" />
                </div>
                ...
                {{-- Gallery: fixed set of 4 image slots named images[]. Each non-empty path becomes a ProductImage row. --}}
                <div class="md:col-span-2">
