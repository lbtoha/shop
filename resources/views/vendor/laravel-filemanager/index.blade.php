...
<body>
    ...
    <div class="d-flex flex-row lfm-content">
        <div id="tree"></div>
    ...
    <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-levelledby="myModallevel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModallevel">{{ trans('laravel-filemanager::lfm.title-upload') }}
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aia-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.filemaneger.unisharp.lfm.upload') }}" role='form'
    ...
    <script>
        ...
        var actions = [
            ...
            // },
            {
                name: 'rename',
                icon: 'edit',
                level: lang['menu-rename'],
                multiple: false
            },
            {
                name: 'download',
                icon: 'download',
                level: lang['menu-download'],
                multiple: true
            },
            // {
            //   name: 'preview',
            //   icon: 'image',
            //   level: lang['menu-view'],
            //   multiple: true
            // },
            {
                name: 'move',
                icon: 'paste',
                level: lang['menu-move'],
                multiple: true
            },
            {
                name: 'resize',
                icon: 'arrows-alt',
                level: lang['menu-resize'],
                multiple: false
            },
            {
                name: 'crop',
                icon: 'crop',
                level: lang['menu-crop'],
                multiple: false
            },
            {
                name: 'trash',
                icon: 'trash',
                level: lang['menu-delete'],
                multiple: true
            },
        ];
        ...
        var sortings = [{
                ...
                level: lang['nav-sort-alphabetic']
            },
            {
                by: 'time',
                icon: 'sort-numeric-down',
                level: lang['nav-sort-time']
            }
        ];
    </script>
