...
@section('content')
    <div class="max-w-5xl mx-auto px-4 py-8">
        ...
        <form method="POST" action="{{ route('shop.checkout.store') }}" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 bg-white border border-[color:var(--color-line)] rounded-2xl p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="shipping_address" rows="3" required
                            class="w-full border border-[color:var(--color-line)] rounded-lg py-2.5 px-3.5 focus:outline-none focus:border-[color:var(--color-brand)]">{{ old('shipping_address') }}</textarea>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="note" rows="2"
                            class="w-full border border-[color:var(--color-line)] rounded-lg py-2.5 px-3.5 focus:outline-none focus:border-[color:var(--color-brand)]">{{ old('note') }}</textarea>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white border border-[color:var(--color-line)] rounded-2xl p-6 sticky top-24">
                    ...
                    <button type="submit"
                        class="mt-5 w-full bg-[color:var(--color-brand)] hover:bg-[color:var(--color-brand-dark)] text-white font-medium py-3 rounded-full transition">
                        {{ __('Place Order') }}
                    </button>
                </div>
            </div>
