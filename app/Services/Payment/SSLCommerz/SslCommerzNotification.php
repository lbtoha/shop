...
namespace App\Services\Payment\SSLCommerz;
...
class SslCommerzNotification extends AbstractSslCommerz
{
     ...
     */
    public function __construct($storeId, $storePassword, $testMode = false)
    {
        $this->testMode = $testMode;
        $this->setConfig($storeId, $storePassword);
        $this->setStoreId($storeId);
        $this->setStorePassword($storePassword);
    }

    protected function setConfig($storeId, $storePassword)
    {
        $apiDomain = $this->testMode ? 'https://sandbox.sslcommerz.com' : 'https://securepay.sslcommerz.com';
        ...
        $this->config = [
            ...
            'apiDomain' => $apiDomain,
            'connect_from_localhost' => $this->testMode,
        ];
    }
