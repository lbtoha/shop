import{m as lt}from"./moment-CWGZoW8q.js";import"./_commonjsHelpers-D6-XlEtG.js";const ft=()=>{};var de={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qt{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(zt(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function zt(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Y="@firebase/app",ge="0.13.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const An="firebase-heartbeat-database",Dn=1,A="firebase-heartbeat-store";let x=null;function Le(){return x||(x=R(An,Dn,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(A)}catch(n){console.warn(n)}}}}).catch(e=>{throw m.create("idb-open",{originalErrorMessage:e.message})})),x}async function Cn(e){try{const n=(await Le()).transaction(A),r=await n.objectStore(A).get(He(e));return await n.done,r}catch(t){if(t instanceof S)g.warn(t.message);else{const n=m.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});g.warn(n.message)}}}async function be(e,t){try{const r=(await Le()).transaction(A,"readwrite");await r.objectStore(A).put(t,He(e)),await r.done}catch(n){if(n instanceof S)g.warn(n.message);else{const r=m.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});g.warn(r.message)}}}function He(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pn(e){E(new w("platform-logger",t=>new qt(t),"PRIVATE")),E(new w("heartbeat",t=>new Nn(t),"PRIVATE")),b(Y,ge,e),b(Y,ge,"esm2017"),b("fire-js","")}Pn("");var $n="firebase",Fn="11.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */b($n,Fn,"app");const je="@firebase/installations",re="0.6.18";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xe=1e4,Ve=`w:${re}`,Ue="FIS_v2",Ln="https://firebaseinstallations.googleapis.com/v1",Hn=3600*1e3,jn="installations",xn="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vn={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."},v=new B(jn,xn,Vn);function Ke(e){return e instanceof S&&e.code.includes("request-failed")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function We({projectId:e}){return`${Ln}/projects/${e}/installations`}function qe(e){return{token:e.token,requestStatus:2,expiresIn:Kn(e.expiresIn),creationTime:Date.now()}}async function ze(e,t){const r=(await t.json()).error;return v.create("request-failed",{requestName:e,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})}function Ge({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function Un(e,{refreshToken:t}){const n=Ge(e);return n.append("Authorization",Wn(t)),n}async function Je(e){const t=await e();return t.status>=500&&t.status<600?e():t}function Kn(e){return Number(e.replace("s","000"))}function Wn(e){return`${Ue} ${e}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const er="firebase-installations-database",tr=1,_="firebase-installations-store";let V=null;function oe(){return V||(V=R(er,tr,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(_)}}})),V}async function M(e,t){const n=P(e),o=(await oe()).transaction(_,"readwrite"),i=o.objectStore(_),a=await i.get(n);return await i.put(t,n),await o.done,(!a||a.fid!==t.fid)&&Qe(e,t.fid),t}async function et(e){const t=P(e),r=(await oe()).transaction(_,"readwrite");await r.objectStore(_).delete(t),await r.done}async function $(e,t){const n=P(e),o=(await oe()).transaction(_,"readwrite"),i=o.objectStore(_),a=await i.get(n),s=t(a);return s===void 0?await i.delete(n):await i.put(s,n),await o.done,s&&(!a||a.fid!==s.fid)&&Qe(e,s.fid),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rt="installations",yr="installations-internal",Ir=e=>{const t=e.getProvider("app").getImmediate(),n=wr(t),r=ne(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Er=e=>{const t=e.getProvider("app").getImmediate(),n=ne(t,rt).getImmediate();return{getId:()=>gr(n),getToken:o=>mr(n,o)}};function vr(){E(new w(rt,Ir,"PUBLIC")),E(new w(yr,Er,"PRIVATE"))}vr();b(je,re);b(je,re,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _r="/firebase-messaging-sw.js",Sr="/firebase-cloud-messaging-push-scope",ot="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",Tr="https://fcmregistrations.googleapis.com/v1",it="google.c.a.c_id",Ar="google.c.a.c_l",Dr="google.c.a.ts",Cr="google.c.a.e",ve=1e4;var _e;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(_e||(_e={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jr=10080*60*1e3;async function xr(e){const t=await Ur(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:h(t.getKey("auth")),p256dh:h(t.getKey("p256dh"))},r=await Pr(e.firebaseDependencies);if(r){if(Kr(r.subscriptionOptions,n))return Date.now()>=r.createTime+jr?Vr(e,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{await Hr(e.firebaseDependencies,r.token)}catch(o){console.warn(o)}return Te(e.firebaseDependencies,n)}else return Te(e.firebaseDependencies,n)}async function Vr(e,t){try{const n=await Lr(e.firebaseDependencies,t),r=Object.assign(Object.assign({},t),{token:n,createTime:Date.now()});return await se(e.firebaseDependencies,r),n}catch(n){throw n}}async function Te(e,t){const r={token:await Fr(e,t),createTime:Date.now(),subscriptionOptions:t};return await se(e,r),r.token}async function Ur(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:kr(t)})}function Kr(e,t){const n=t.vapidKey===e.vapidKey,r=t.endpoint===e.endpoint,o=t.auth===e.auth,i=t.p256dh===e.p256dh;return n&&r&&o&&i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xr(e){try{e.swRegistration=await navigator.serviceWorker.register(_r,{scope:Sr}),e.swRegistration.update().catch(()=>{}),await Qr(e.swRegistration)}catch(t){throw f.create("failed-service-worker-registration",{browserErrorMessage:t==null?void 0:t.message})}}async function Qr(e){return new Promise((t,n)=>{const r=setTimeout(()=>n(new Error(`Service worker not registered after ${ve} ms`)),ve),o=e.installing||e.waiting;e.active?(clearTimeout(r),t()):o?o.onstatechange=i=>{var a;((a=i.target)===null||a===void 0?void 0:a.state)==="activated"&&(o.onstatechange=null,clearTimeout(r),t())}:(clearTimeout(r),n(new Error("No incoming service worker found.")))})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ro(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===D.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(Ae(n)):e.onMessageHandler.next(Ae(n)));const r=n.data;Gr(r)&&r[Cr]==="1"&&await to(e,n.messageType,r)}const De="@firebase/messaging",Ce="0.12.22";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uo(e=Tn()){return so().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),ne(ee(e),"messaging").getImmediate()}async function lo(e,t){return e=ee(e),ut(e,t)}function fo(e,t){return e=ee(e),co(e,t)}ao();async function ho(){try{const e=await po();if(e!=null&&e.vapidKey){const t=Fe(e),n=uo(t);if(await Notification.requestPermission()==="granted")try{const o=await lo(n,{vapidKey:e.vapidKey});o?mo(o):console.log("No registration token available.")}catch(o){console.warn("Error retrieving token:",o)}else console.warn("Notification permission denied.");fo(n,o=>{if(o.notification){const i=new Notification(o.notification.title,{body:o.notification.body});go({...o.notification,created_at:new Date}),i.onclick=function(){window.focus(),this.close()}}})}}catch{console.warn("Error initializing Firebase")}}async function po(){try{return await(await fetch("/firebase/cloud-messaging.json")).json()}catch{return null}}function go(e){const t=document.querySelector("#notification-list-container"),n=document.querySelector("#notification-count"),r=`<div
                                ...
                                <div class="text-sm">
                                    <div class="flex gap-1">
                                        <span>${e==null?void 0:e.body}</span>
                                    </div>
                                    <span
                                        class="text-xs text-n100 dark:text-n50">${lt(e.created_at).fromNow()}</span>
                                </div>
                            </div>`;t.insertAdjacentHTML("afterbegin",r);const o=parseInt(n.textContent)||0;n.textContent=o+1}function mo(e){var t;fetch("/admin/settings/notification/token-update",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":(t=document.querySelector('meta[name="csrf-token"]'))==null?void 0:t.getAttribute("content")},body:JSON.stringify({token:e})}).then(n=>{if(!n.ok)throw new Error(`HTTP error! status: ${n.status}`);return n.json()}).then(n=>console.log("Topic subscription result:",n)).catch(n=>console.warn("Something went wrong."))}ho();
